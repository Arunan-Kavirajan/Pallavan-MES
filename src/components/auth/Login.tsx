  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Pallavan Precision Works</h1>
        <h2 className="text-sm font-medium text-blue-600 tracking-wider uppercase mt-1">
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="p-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-6 flex items-center">
            <KeyRound className="mr-2 text-gray-400" size={20} />
            Employee Sign In
          </h3>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm uppercase"
