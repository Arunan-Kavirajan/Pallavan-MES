...
const filesToCopy = [
  { prefix: 'Pallavan MES Setup', dest: 'Pallavan-MES-Windows.exe' },
  { prefix: 'Pallavan MES-', ext: '.dmg', dest: 'Pallavan-MES-Mac.dmg' },
  { prefix: 'Pallavan MES-', ext: '.AppImage', dest: 'Pallavan-MES-Linux.AppImage' }
];
